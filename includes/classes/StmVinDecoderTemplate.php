...
class StmVinDecoderTemplate {
	 ...
	 * @return string
	 */
	public static function locate_template($template_name, $template_path = 'motors-vin-decoder/', $default_path = '') {
		$template_name .= '.php';
	 ...
	 * @return bool|string
	 */
	public static function load($template_name, $args = array(), $template_path = 'motors-vin-decoder/', $default_path = ''){
		ob_start();
		if(is_array($args))
			extract( $args );
	...
	public static function template_path() {
		return apply_filters( 'motors_vin_decoder_template_path', 'motors-vin-decoder/' );
	}
	...
	public static function plugin_path($default_path = '') {
		...
		return untrailingslashit(STM_MOTORS_VIN_DECODERS_PATH.'/templates/');
	}
}